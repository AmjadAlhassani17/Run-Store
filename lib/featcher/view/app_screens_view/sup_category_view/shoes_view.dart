                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return InkWell(
                        onTap: (){
                          Get.to(() => DetailsAboutItemView(productData : ShoesView.dioMethods.shoes
                                                .elementAt(index)));
                        },
                        child: Container(
                          width: double.infinity,
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    CustomText(text: ShoesView.dioMethods.shoes.elementAt(index).title, color: ColorSelect.TextNewArrival, fontsize: 16, textAlign: TextAlign.left, fontWeight: FontWeight.w400, textOverflow: TextOverflow.ellipsis, height: 0.0,),
