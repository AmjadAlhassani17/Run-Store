                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Get.to(() => DetailsAboutItemView(productData : OthersView.dioMethods.others
                                                .elementAt(index)));
                        },
                        child: Container(
                          width: double.infinity,
                            ...
                            children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Utils.instance.networkImage(
                                      imageUrl: OthersView.dioMethods.others
                                          .elementAt(index)
                                          .images[0],
                                      fit: BoxFit.fill,
                                    ),
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                if (snapshot.data ?? false) {
                                                  ...
                                                  setState(() {
                                                    controller
                                                      .deleteProduct(OthersView.dioMethods.others
                                                  .elementAt(index)
                                                  .id);
                                                  });
                                                } else {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CustomText(
                                      text: OthersView.dioMethods.others
                                          .elementAt(index)
                                          .category
                                          .name,
                                      color: ColorSelect.textColor,
                                    ...
                                    CustomText(
                                      text:
                                          '\$${OthersView.dioMethods.others.elementAt(index).price}',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    CustomPriceWithLine(
                                      text:
                                          '\$${OthersView.dioMethods.others.elementAt(index).price + 56}',
