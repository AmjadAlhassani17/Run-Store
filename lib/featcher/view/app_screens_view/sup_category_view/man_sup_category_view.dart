...
class ManSupCategoryView extends StatefulWidget {
  ...
  @override
  State<ManSupCategoryView> createState() => _ManSupCategoryViewState();
}

class _ManSupCategoryViewState extends State<ManSupCategoryView> {
  @override
                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return InkWell(
                        onTap: () {
                          Get.to(() => DetailsAboutItemView(productData : ManSupCategoryView.dioMethods.supman
                                                .elementAt(index)));
                        },
                        child: Container(
                          width: double.infinity,
                            ...
                            children: [
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                if (snapshot.data ?? false) {
                                                  ...
                                                  setState(() {
                                                    controller
                                                      .deleteProduct(ManSupCategoryView
                                                  .dioMethods.supman
                                                  .elementAt(index)
                                                  .id);
                                                  });
                                                    ...
                                                    CartProduct(
                                                      ...
                                                      description:
                                                          ManSupCategoryView
                                                              ...
                                                              .elementAt(index)
                                                              .description,
                                                      image: ManSupCategoryView
                                                          .dioMethods.supman
                                                          .elementAt(index)
                                                          .images
                                                          .first,
                                                      price: ManSupCategoryView
                                                          .dioMethods.supman
                                                          .elementAt(index)
                                                          .price,
                                                      id: ManSupCategoryView
                                                          .dioMethods.supman
                                                          .elementAt(index)
                                                          .id,
                                                    ),
                                                ...
                                                return InkWell(
                                                      onTap: () {
                                                        ...
                                                        controller2.addProduct(
                                                          ...
                                                          .elementAt(index)
                                                                .title,
                                                            description: ManSupCategoryView
                                                          .dioMethods.supman
                                                          .elementAt(index)
                                                                .description,
                                                            image: ManSupCategoryView
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CustomText(
                                      text: ManSupCategoryView.dioMethods.supman
                                          .elementAt(index)
                                          .category
                                          .name,
                                      color: ColorSelect.textColor,
                                    ...
                                    CustomText(
                                      text:
                                          '\$${ManSupCategoryView.dioMethods.supman.elementAt(index).price}',
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    CustomPriceWithLine(
                                      text:
                                          '\$${ManSupCategoryView.dioMethods.supman.elementAt(index).price + 56}',
