      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            CustomText(
              text: ClothingView.dioMethods.clothes.elementAt(0).category.name,
              color: ColorSelect.textColor,
              fontsize: 34,
              textAlign: TextAlign.center,
              fontWeight: FontWeight.w600,
                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      if (ClothingView.dioMethods.clothes.isEmpty) {
                        return Center(
                            ...
                            children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Utils.instance.networkImage(
                                      imageUrl: ClothingView.dioMethods.clothes.elementAt(index).images.first ,
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                  Positioned(
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                if (snapshot.data ?? false) {
                                                  ...
                                                  setState(() {
                                                    controller
                                                      .deleteProduct(ClothingView.dioMethods.clothes.elementAt(index)
                                                  .id);
                                                  });
                                                } else {
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    CustomText(text: ClothingView.dioMethods.clothes.elementAt(index).category.name, color: ColorSelect.textColor, fontsize: 16, textAlign: TextAlign.left, fontWeight: FontWeight.w400, textOverflow: TextOverflow.clip, height: 0.0,),
                                    CustomText(text: '\$${ClothingView.dioMethods.clothes.elementAt(index).price}', color: ColorSelect.primarycolor, fontsize: 16, textAlign: TextAlign.right, fontWeight: FontWeight.w400, textOverflow: TextOverflow.clip, height: 0.0,),
                                  ],
                                ),
                              ),
                              SizedBox(height: 10,),
                    ...
                    itemCount: ClothingView.dioMethods.clothes.length,
